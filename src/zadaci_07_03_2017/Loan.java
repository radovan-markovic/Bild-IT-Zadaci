...
public class Loan {
	...
	public Loan(double annualInterestRate, int numberOdYears, double loanAmount) throws IllegalArgumentException {
		...
		if (annualInterestRate <= 0)
			throw new IllegalArgumentException("annualInterestRate mora biti veci od nule.");
		else if (numberOdYears <= 0)
			throw new IllegalArgumentException("numberOdYears mora biti veic od nule.");
		else if (loanAmount <= 0)
			throw new IllegalArgumentException("loanAmount mora biti veci od nule.");
		else {
